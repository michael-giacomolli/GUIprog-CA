...
public class customerBooker extends JFrame implements WindowListener{
    ...
    public customerBooker(dashController controller){
    ...
    private void attributesSetter(){
        ...
        this.setTitle("ME.barber - BOOKING");
    ...
    private void components(){
        ...
        //----- p1 = TOP PANEL (title) ------------ //
        JLabel title = new JLabel("Select From Available Slots:");
        labelStyller(title);
