...
public class customerFeedback extends JFrame implements WindowListener{
    
    dashController controller;
    
    Color bg = new Color(241,106,100);
        
    public customerFeedback(dashController controller){
    ...
    private void attributesSetter(){
        ...
        this.setTitle("ME.barber - Feedback");
    ...
    private void components(){
        ...
        //----- p1 = TOP PANEL (title) ------------ //
        JLabel title = new JLabel("Give your feedback:");
        labelStyller(title);
        ...
        JButton select = new JButton(" Send ");
